...
import 'hoem_user_screen.dart';

class ViewDetailes extends StatefulWidget {
  ViewDetailes({Key? key, required this.id}) : super(key: key);
  String id;

  @override
  State<ViewDetailes> createState() => _ViewDetailesState();
}
class _ViewDetailesState extends State<ViewDetailes> {
  @override
            ...
            ? Scaffold(
                appBar: AppBar(
                  ...
                  actions: [
                    IconButton(
                        onPressed: () {
                          ControllerCubit.get(context).deleteTreatement(widget.id);
                        },
                      ...
                      child: Form(
                        ...
                        child: Column(
                          ...
                          children: [
                                  ...
                                  children: [
                                    (state is UploadImageStateLoading)
                                        ...
                                        : CustomButton(
                                            ...
                                            function: () {
                                              ControllerCubit.get(context)
                                                  .pickImageGallaryTreatmentUpdate(
                                                      context,
                                                      ControllerCubit.get(context)
                                                          .treatMentModelOne!
                                                          .id);
                                    ...
                                    (state is UploadImageStateLoading)
                                        ...
                                        : CustomButton(
                                            ...
                                            function: () {
                                              ControllerCubit.get(context)
                                                  .pickImageCameraTreatmentUpdate(
                                                      context,
                                                      ControllerCubit.get(context)
                                                          .treatMentModelOne!
                                                          .id);
                            ...
                            //     },
                            //     child: Text("")),
                            (ControllerCubit.get(context).treatMentModelOne!.amount ==
                                    0)
                                ? const SizedBox()
                                : CustomButton(
                                    size: Size(150.w, 40.h),
                                    ...
                                    function: () async {
                                      ...
                                      if (int.parse(amoutController.text) > 1) {
                                        notivication(
                                          ...
                                          sound: ControllerCubit.get(context)
                                              .treatMentModelOne!
                                              .nameSound,
                                          title: 'Take Medicine',
