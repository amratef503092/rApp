...
class History_View_details extends StatefulWidget {
  History_View_details({Key? key, required this.id}) : super(key: key);
  String id;

  @override
  State<History_View_details> createState() => _History_View_detailsState();
}
class _History_View_detailsState extends State<History_View_details> {
  @override
