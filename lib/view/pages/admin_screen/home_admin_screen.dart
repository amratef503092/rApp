...
import 'package:p3/view/pages/admin_screen/search_user.dart';
...
import '../users/Edit_Info.dart';
import 'approveUser.dart';
...
class _HomeAdminScreenState extends State<HomeAdminScreen> {
  ...
  builder: (context, state) {
    return Scaffold(
      ...
      drawer: (ControllerCubit.get(context).userModel!=null)?Drawer(
        child: ListView(
          children: [
             DrawerHeader(
              child: Column(
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(context, MaterialPageRoute(
                  builder: (context) {
                    return const CustomerScreenAdmin();
                  },
                ));
                // ...
              },
